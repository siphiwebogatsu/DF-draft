...
<!--chapter:end:02-survey-design-sampling-weighting.Rmd-->
...
dat = dat |>
  select(CountryName, Location, HHID,VillageID, ChildID, Tier_One_Unit,
         ch02, ch06b, enr_status, pt02b, ch03,
...
dat |> 
  filter(enr_status == "Currently Enrolled") |>
  skim()
...
To customise the summaries we want to see we can use `skim_with` alongside the `sfl()` helper function. For now, let us see only the numeric variables and show only the mean, sd, interquartile range, and the median of each variable. 
...
<!--chapter:end:03-understanding-distributions.Rmd-->
...
<!--chapter:end:04-central-tendency-dispersion.Rmd-->
...
<!--chapter:end:05-bivariate-analysis.Rmd-->
...
<!--chapter:end:06-simple-linear-regression.Rmd-->
...
<!--chapter:end:08-logisticreg.Rmd-->
